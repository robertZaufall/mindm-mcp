...
async def create_mindmap_from_mermaid(
    ...
    - Every line must be valid Mermaid and contain at least a topic label.
    - Full syntax supports attaching metadata via JSON after `%%`, e.g.
